...
void AAnomaly_Object_Shelf::OnBookHit(UPrimitiveComponent* HitComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
...
void AAnomaly_Object_Shelf::PlayRandomDropSound(UStaticMeshComponent* BookMesh, const FVector& WorldLocation, float DropImpulse)
{
	if (!BookMesh)
	{
		return;
